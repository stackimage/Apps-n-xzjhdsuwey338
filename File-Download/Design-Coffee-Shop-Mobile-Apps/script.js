const firebaseConfig = {
    ...
    measurementId: "G-S3C207VCCX"
     ...
     const db = firebase.database().ref("View Design-Coffee-Shop-Mobile-Apps");
...
downloadButton.addEventListener("click", () => {
    ...
    var downloadtimer = setInterval(function timecount() {
        ...
        if (timeleft <= 0) {
            ...
            let download_href = "Design Coffee Shop Mobile Apps - Stack Image.rar";
...
function clicked() {
    ...
    xhr.open("GET", "https://api.countapi.xyz/hit/Design-Coffee-Shop-Mobile-App/awesomeclick");
