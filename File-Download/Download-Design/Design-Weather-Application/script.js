const firebaseConfig = {
    ...
    measurementId: "G-S3C207VCCX"
     ...
     const db = firebase.database().ref("View Design-Weather-Application");
...
downloadButton.addEventListener("click", () => {
    ...
    var downloadtimer = setInterval(function timecount() {
        ...
        if (timeleft <= 0) {
            ...
            let download_href = "Design Weather Application - Stack Image.rar";
...
function clicked() {
    ...
    xhr.open("GET", "https://api.countapi.xyz/hit/Design-Weather-Application/awesomeclick");
