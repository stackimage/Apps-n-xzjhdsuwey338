const firebaseConfig = {
    ...
    measurementId: "G-S3C207VCCX"
     ...
     const db = firebase.database().ref("View Design-Blog-App");
...
downloadButton.addEventListener("click", () => {
    ...
    var downloadtimer = setInterval(function timecount() {
        ...
        if (timeleft <= 0) {
            ...
            let download_href = "Design Blog App - Stack Image.rar";
...
function clicked() {
    ...
    xhr.open("GET", "https://api.countapi.xyz/hit/Design-Blog-App/awesomeclick");
