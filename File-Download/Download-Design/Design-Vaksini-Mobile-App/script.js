const firebaseConfig = {
    ...
    measurementId: "G-S3C207VCCX"
     ...
     const db = firebase.database().ref("View Design-Vaksini-Mobile-App");
...
downloadButton.addEventListener("click", () => {
    ...
    var downloadtimer = setInterval(function timecount() {
        ...
        if (timeleft <= 0) {
            ...
            let download_href = "Design Vaksini Mobile App - Stack Image.rar";
...
function clicked() {
    ...
    xhr.open("GET", "https://api.countapi.xyz/hit/Design-Vaksini-Mobile-App1212/awesomeclick");
